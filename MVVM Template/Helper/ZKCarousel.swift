...
final public class ZKCarousel: UIView, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    public lazy var pageControl : UIPageControl = {
        ...
        control.pageIndicatorTintColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0.5)
    ...
    private func setupCarousel() {
        ...
        NSLayoutConstraint(item: pageControl, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1.0, constant: -25).isActive = true
