...
open class SweetAlert: UIViewController {
    ...
    fileprivate func setupSubtitleTextView() {
        ...
        subTitleTextView.sizeThatFits(subTitleTextView.bounds.size)
    }
   ...
   @discardableResult open func showAlert(_ title: String, subTitle: String?, style: AlertStyle) -> SweetAlert {
        _ = showAlert(title, subTitle: subTitle, style: style, buttonTitle: "OK")
        return self

    }

   @discardableResult open func showAlert(_ title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        _ = showAlert(title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor:UIColor.red)
        userAction = action
        return self
    }
