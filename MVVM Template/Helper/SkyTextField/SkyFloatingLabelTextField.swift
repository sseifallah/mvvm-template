...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
     ...
     */
    @objc open var isLTRLanguage: Bool = !UserDefaults.standard.bool(forKey: "rtl") {
        didSet {
           updateTextAligment()
        }
    }
    ...
    fileprivate func updatePlaceholder() {
        ...
        if(UserDefaults.standard.bool(forKey: "rtl")){
            ...
            attributedPlaceholder = NSAttributedString(
                string: placeholder,
                attributes: [
                    NSAttributedString.Key.foregroundColor: color, NSAttributedString.Key.font: font, NSAttributedString.Key.paragraphStyle: centeredParagraphStyle
                ]
            )
        #elseif swift(>=4.0)
        let centeredParagraphStyle = NSMutableParagraphStyle()
        ...
        centeredParagraphStyle.alignment = .left
            ...
            attributedPlaceholder = NSAttributedString(
                string: placeholder,
                attributes: [
                    NSAttributedStringKey.foregroundColor: color, NSAttributedStringKey.font: font, NSAttributedString.Key.paragraphStyle: centeredParagraphStyle
                ]
            )
        #else
            attributedPlaceholder = NSAttributedString(
    ...
    */
    open func titleLabelRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        if editing {
            return CGRect(x: 0, y: -5, width: bounds.size.width, height: titleHeight())
        }
        return CGRect(x: 0, y: titleHeight() - 5, width: bounds.size.width, height: titleHeight())
    }
