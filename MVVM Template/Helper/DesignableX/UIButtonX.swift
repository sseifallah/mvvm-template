   ...
   //    MARK: - Gradient
    ...
    @IBInspectable var spacing: CGFloat = 0 {
        didSet {
            ...
            imageEdgeInsets = UIEdgeInsets(top: 0.0, left: spacing - imageViewWidth / 2, bottom: 0.0, right: 0.0)
            titleEdgeInsets = UIEdgeInsets(top: 0.0, left: ((bounds.width) - imageViewWidth)/2, bottom: 0.0, right: 0.0)
            print((bounds.width - titleLabelWidth) / 2 - imageViewWidth)
        }
    }
    
    @IBInspectable var verticalSpacing: CGFloat = 6 {
        didSet {
            guard
            ...
            let totalHeight = imageViewSize.height + titleLabelSize.height + verticalSpacing

            self.imageEdgeInsets = UIEdgeInsets(
                top: 10 - (totalHeight - imageViewSize.height),
                left: 0.0,
                bottom: 0.0,
    ...
    @IBInspectable var horizontalSpacing: CGFloat = 6 {
        didSet {
            ...
            self.titleEdgeInsets = UIEdgeInsets(
                top: 0.0,
                left: -imageViewSize.width - horizontalSpacing,
                bottom: -(totalHeight - titleLabelSize.height + 10),
                right: 0.0
            )
